...
- [x] **Update CLAUDE.md hardware note** — done 2026-05-02. Tech Stack + Known Issues lines now point future sessions at `system_check.classify()` for per-machine truth; home PC POWER-tier specs called out as the verified example.
